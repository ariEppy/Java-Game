...
public class BoardLevel1 extends Board
{
	...
	//choose randomly a color from 1-5 from the colors array and add it to the arraylist colorsoftheboxes
	@Override
	...
	public void updateTheseModelBoxes(int[] indexes) 
	{
		...
		for(int j= 0; j<= down/10; j++)
		{
			for(int i = (j*10) + indexes[0]; i<= indexes[0]+across+ (j*10); i++)
			{
				...
				System.out.println("index: "+ i+ "color: " + boxColor);
